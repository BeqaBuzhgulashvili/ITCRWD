...
<html lang="<?=$lang;?>">
	<head>
		<title>ITCrowd - Consultation</title>
		<meta charset="utf-8">
										...
										<li class="nav-item sub-menu"><a class="nav-link active"><?=$tr["services"][$lang];?> <i class="fa fa-caret-down" aria-hidden="true"></i></a>
											<div class="sf-mega">
												<ul>
													...
													<li><a class="active2" href="consultation.php"><?=$tr["consultation"][$lang];?></a></li>
												</ul>
											</div>
										</li>
			...
			<div class="content-wrapper">
				...
				<div class="content-inner">
					<div class="breadcrumbs1_wrapper">
						<div class="container">
							<div class="breadcrumbs1"><a href="index.php"><i class="fa fa-home" aria-hidden="true"></i></a><span>/</span><?=$tr["consultation"][$lang];?></div>
						</div>
					</div>
					<div id="content" class="page-section">
						<div class="container">
							<div class="title1">IT <span class="font-size"><?=$tr["consultation"][$lang];?></span></div>
							<div class="title2"><?=$tr["consultation_text"][$lang];?></div>
							<br>
							<div class="title3"><?=$tr["today"][$lang];?> <span>...</span></div>
							<p>
								<?=$tr["p1"][$lang];?>
							</p>
							<p>
